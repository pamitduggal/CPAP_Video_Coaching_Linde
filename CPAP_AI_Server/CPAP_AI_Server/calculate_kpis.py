...
def compute_and_save_kpis():
    ...
    pap = pd.read_csv("patient_action_plan.csv")
    feats = pd.read_csv("features_merged.csv")
    l0 = pd.read_csv("layer0_results.csv")
    l3 = pd.read_csv("layer3_results.csv")
    l6 = pd.read_csv("layer6_events.csv") if os.path.exists("layer6_events.csv") else None
